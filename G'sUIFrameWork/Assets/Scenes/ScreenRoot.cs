...
public class ScreenRoot : MonoBehaviour
{
    ...
    {
		DebugUtil.Assert( _animationComp != null, string.Format( "Animation reference is null! {0}", name ) );
		DebugUtil.Assert( _animationComp.GetClip( clipName ) != null, string.Format( "Animation comp has no clip namedd {0}", clipName ) );
